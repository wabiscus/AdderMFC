...
// AdderMFC.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CAdderMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CAdderMFCApp

CAdderMFCApp::CAdderMFCApp()
{
...
// Le seul et unique objet CAdderMFCApp

CAdderMFCApp theApp;


// Initialisation de CAdderMFCApp

BOOL CAdderMFCApp::InitInstance()
{
